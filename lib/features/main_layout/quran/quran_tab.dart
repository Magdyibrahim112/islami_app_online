...
class _QuranTabState extends State<QuranTab> {
  ...
  GlobalKey<MostResentSurasState> mostResentKey = GlobalKey<MostResentSurasState>();
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              MostResentSuras(key: mostResentKey,),///
              SizedBox(height: 10),
              Text(
                "Suras List",
                style: TextStyle(
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) =>
                    SuraItem(sura: filterdSuras[index], mostResentKey: mostResentKey,),
